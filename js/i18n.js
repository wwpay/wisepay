// 수정: 2026-06-25 00:20 — 주민세 툴팁 예시에 납기한(7월 10일) 추가
'use strict';
...
function applyLang() {
  ...
  setHtml('tip-jumin',
    ...
    '구청·시청에서 보내는 특별징수 통지서의 월별 금액을 입력하세요.<br>※ 월별 금액 기준은 \'지급일\'입니다.<br><br>예) 6월분 주민세(7월 10일 납기한) → 6월 10일 지급(5월분 급여)에서 공제<br><br>※ 6월분은 연간 합계의 단수 조정으로 다른 달과 금액이 다를 수 있습니다.'
  );
